...
return [
    ...
    'summernote'=>[
        'ask' => "['common', ['style','bold','color','ol', 'paragraph','table','link','picture','video','clear','fullscreen']]",
        'blog' => "['common', ['style','bold','color','ol', 'paragraph','table','link','picture','video','clear','fullscreen']]",
    ],
